...
在上传的页面中，显示当前待上传的文件或文件夹，用户可以选择开始全部任务、暂停全部任务、清空已完成任务、删除全部任务、上传和删除单个文件/文件夹。
