...
**<li>确认创建</li>**
（1）检查填写的各项信息无误后，点击 “确定” 按钮提交创建任务。系统会根据镜像修改内容大小进行处理，制作时间可能从数秒到数分钟不等。可在 “快照” 列表查看制作进度，制作完成后，前往 “桌面端 -> 应用模板” 文件夹下查看用户应用模板制作结果。
...
（3）模板创建成功后，用户可以从桌面上进入"应用模板"，可以看到创建成功的模板信息。
